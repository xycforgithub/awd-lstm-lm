...
# python generate_scores.py --out_dataset_name marco --normalize_lm_score --out_score_on
python generate_scores.py --out_dataset_name newsqa --out_score_on --normalize_lm_score
